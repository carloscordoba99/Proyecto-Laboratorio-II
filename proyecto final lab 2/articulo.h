...
bool Articulo::cargar()
{
    ...
    if(buscar_art_nombre(nombre)!=-1){
        cout << "Ya se encuentra registrado el nombre del artículo. " << endl;
        system("pause");
        return false;
    }
...
void leer_precio_art()
{
    ...
    ordenar_art2(p,tam);
    cout << "Artículos por precio: " << endl;
    for (int i=0; i<tam; i++)
    {
...
void alta_art()
{
    ...
    if(reg.cargar()==true)
    {
        ...
        {
            cout << "El artículo se grabó con exito. " << endl;
            system("pause");
        }
    }
...
void baja_articulo()
{
    ...
    {
        cout << "El artículo se dio de baja. " << endl;
        system("pause");
    }
}
